...
public class ManagerActivity extends AppCompatActivity
        ...
        CreateEventFragment.OnFragmentInteractionListener, ProfileFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().add(R.id.fragment_container, new EditableEventsFragment(), "Events").commit();
    }
